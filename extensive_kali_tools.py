...
# Add additional tools while avoiding duplicates
def add_tools_if_not_exist(tools_to_add):
    existing_tool_names = {tool["name"].lower() for tool in KALI_TOOLS}
    new_tools = []
    ...
    if new_tools:
        KALI_TOOLS.extend(new_tools)

# Information Gathering tools
add_tools_if_not_exist([
    {
        "name": "fierce",
        "category": "Information Gathering",
        "description": "Domain DNS scanner that can locate non-contiguous IP space and hostnames against specified domains",
